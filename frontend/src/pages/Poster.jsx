...
export default function PosterSwiper() {
  ...
  return (
    <div className="relative flex justify-center w-full py-16 bg-white">
      {/* Poster container with landscape aspect ratio */}
      <div className="relative w-full max-w-5xl aspect-[18/9] rounded-xl overflow-hidden shadow-2xl">
        <img
          src={posters[current]}
