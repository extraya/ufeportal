          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-2 py-1 text-xs text-white bg-red-600 rounded sm:px-3 sm:text-sm hover:bg-red-700"
              >
                Устгах
              </button>
            </div>
              ...
              {semester.courses.map((course, cIdx) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="text-xs text-red-500 sm:text-sm hover:text-red-700"
                  >
                    Устгах
                  </button>
                </div>
            ...
            <div className="flex items-center justify-between pt-2">
              <button
                ...
                className="px-2 py-1 text-xs text-white bg-blue-600 rounded sm:px-3 sm:py-1.5 sm:text-sm hover:bg-blue-700"
              >
                Хичээл нэмэх
              </button>
